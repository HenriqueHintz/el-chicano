        ...
        <div className="relative max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="flex flex-col items-center mb-8">
                  <div className="relative w-20 h-20 mb-4">
                    <div className="absolute inset-0 bg-orange-600 rounded-full blur-md opacity-20 animate-pulse" />
                    <Image
          ...
          <div className="flex flex-col items-center gap-8 mt-16">
            <div className="flex items-center gap-12">
              <button
                onClick={() => paginate(-1)}
                className="w-14 h-14 flex items-center justify-center rounded-full border border-white/10 hover:border-green-600 text-white/40 hover:text-white transition-all duration-500 group"
              >
              ...
              <div className="flex gap-3">
                {siteData.testimonials.map((_, index) => (
                  <button
                    ...
                    className={`h-1.5 transition-all duration-700 rounded-full ${index === currentIndex
