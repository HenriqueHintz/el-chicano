    ...
    return (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 lg:hidden w-[95%] max-w-[440px]">
            <motion.div
                ...
                className="bg-brand-base/80 backdrop-blur-xl border border-brand-light/15 rounded-full p-2 flex items-center justify-between shadow-2xl shadow-brand-accent/20"
            >
                <a
                    href="#menu"
                    className="flex-1 flex flex-col items-center justify-center py-3 px-2 text-brand-light/70 hover:text-brand-accent transition-colors active:bg-brand-light/10 rounded-lg min-h-[48px] touch-manipulation"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex flex-col items-center justify-center py-3 px-2 text-brand-light/70 hover:text-green-500 transition-colors active:bg-brand-light/10 rounded-lg min-h-[48px] touch-manipulation"
