    ...
    testimonials: [
        {
            name: 'Marina Costa',
            role: 'Food Blogger',
            text: 'O melhor restaurante mexicano que já experimentei! Os tacos al pastor são autênticos e os drinks são incríveis.',
            rating: 5,
        ...
        },
        {
            ...
            role: 'Empresário',
            text: 'Fiz meu evento corporativo no El Chicano e foi um sucesso absoluto. Equipe super atenciosa.',
            rating: 5,
...
export const menuItems = {
    ...
    antojitos: [
        { name: 'Nachos - Tortillas Chips', description: '100G De Tortilla Chips De Milho.', price: '20,90', image: '/images/menu/nachos-simples.jpg' },
    ...
    burritos: [
        ...
        { name: 'BURRITO SURF AND TURF', description: 'Tortilla de Trigo, Mussarella, Papas Fritas, Camarão Refogado, Bacon Grelhado, Guacamole, Sour Cream e Acelga Crocante.', price: '68,90', image: '/images/menu/burrito-surf-turf.jpg' },
    ...
    // ... adicione as demais conforme necessário ou importe
};
